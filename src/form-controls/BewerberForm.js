        ...
        <Accordion>
          ...
          <AccordionDetails>
            <Grid container spacing={2}>
              <Grid item xs={6}>
                <AusbildungsartFormControl
                  value={params.ausbildungsart}
                  onChange={onChange}
                  fullWidth
                />
              </Grid>
              <Grid item xs={6}>
                <UmkreisFormControl
                  value={params.umkreis}
                  onChange={onChange}
                  fullWidth
                />
              </Grid>
              <Grid item xs={6}>
                <AngebotsartFormControl
                  value={params.angebotsart}
                  onChange={onChange}
                  fullWidth
                />
              </Grid>
              <Grid item xs={6}>
                <ArbeitszeitFormControl
                  value={params.arbeitszeit}
                  onChange={onChange}
                  fullWidth
                />
              </Grid>
              <Grid item xs={4}>
                <BerufserfahrungFormControl
                  value={params.berufserfahrung}
                  onChange={onChange}
                  fullWidth
                />
              </Grid>
              <Grid item xs={4}>
                <VertragsartFormControl
                  value={params.vertragsart}
                  onChange={onChange}
                  fullWidth
                />
              </Grid>
              <Grid item xs={4}>
                <BehinderungFormControl
                  value={params.behinderung}
                  onChange={onChange}
                  fullWidth
                />
              </Grid>
